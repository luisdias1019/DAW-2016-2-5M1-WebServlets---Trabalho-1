...
<jsp:useBean id="daoEspecialidade" scope="session"
...
<html>
    ...
    <body>
        ...
        <h2><%=daoEspecialidade.getMensagem()%></h2>
        ...
        <table border="1">
            ...
            <tbody>
                <% 
                    for(Especialidade c : daoEspecialidade.getLista()){  // inicio do laço de repetição                  
                %>
                <tr>
                    <td><%=c.getId()%></td>
